...
bool MarkClienToDeleteFromFileByAccountNumber(vector <Sclient> &Vclient, string accountname,string filename=ClientsFileName)
{
...
bool DeleteClientByAccountNumber(vector <Sclient> Vclient, string accouontName)
{
    ...
    if (FindClientByAccountNumber(Vclient, accouontName, client))
    {
        ...
        cin >> answer;
         if (answer == 'y')
        {
             MarkClienToDeleteFromFileByAccountNumber(Vclient, accouontName);
...
int main()
{
    ...
    cin >> accountNumber;
    cout << DeleteClientByAccountNumber(Vclient, accountNumber);
